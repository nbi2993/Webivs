    ...
    if (admin.apps.length === 0) {
        try {
            ...
            const serviceAccountBase64 = process.env.SERVICEACCOUNT_KEY_BASE64; // PHẢI ĐỌC TỪ process.env
    ...
    app.post('/api/chat', async (req, res) => {
        try {
            ...
            const geminiApiKey = process.env.GEMINI_API_KEY; // PHẢI ĐỌC TỪ process.env
